...
import AdminStudentNotifications from './AdminStudentNotificationsComponent';
import AdminTeacherNotifications from './AdminTeacherNotificationsComponent';
    ...
    render() {
        return (
            <Layout style={{height: '100vh'}} className="admin-layout">
                <AdminMenu collapsed={this.state.siderCollapsed} admin={this.props.admin}
                ...
                <Layout className="right-layout" >
                    <AdminHeader onToggle={this.onToggleSiderCollapsed} collapsing={this.state.siderCollapsed}
                        onToggleSiderTheme={this.onToggleSiderTheme} admin={this.props.admin}
                    />
                    <Scrollbars style={{height: '96vh'}}>
                        <Switch>
                            ...
                            <Route exact path="/admin/profile" component={() => (<AdminPersonalProfile admin={this.props.admin} />)} />
